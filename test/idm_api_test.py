...
def test_idm__sync_break_lock_2(idm_sync_daemon, reset_devices):
...
def test_idm__sync_break_lock_3(idm_sync_daemon, reset_devices):
...
def test_idm__sync_convert_1(idm_sync_daemon, reset_devices):
...
def test_idm__sync_convert_2(idm_sync_daemon, reset_devices):
...
def test_idm__sync_convert_3(idm_sync_daemon, reset_devices):
...
def test_idm__sync_renew_1(idm_sync_daemon, reset_devices):
...
def test_idm__sync_renew_2(idm_sync_daemon, reset_devices):
...
def test_idm__sync_renew_timeout_1(idm_sync_daemon, reset_devices):
...
def test_idm__sync_renew_timeout_2(idm_sync_daemon, reset_devices):
...
def test_idm__sync_renew_timeout_3(idm_sync_daemon, reset_devices):
...
def test_idm__sync_renew_timeout_4(idm_sync_daemon, reset_devices):
...
def test_idm__sync_read_lvb_1(idm_sync_daemon, reset_devices):
...
def test_idm__sync_read_lvb_2(idm_sync_daemon, reset_devices):
...
def test_idm__sync_read_lvb_3(idm_sync_daemon, reset_devices):
...
def test_idm__sync_get_host_count(idm_sync_daemon, reset_devices):
...
def test_idm__sync_two_hosts_get_host_count(idm_sync_daemon, reset_devices):
...
def test_idm__sync_three_hosts_get_host_count(idm_sync_daemon, reset_devices):
...
def test_idm__sync_get_lock_mode(idm_sync_daemon, reset_devices):
...
def test_idm__sync_get_lock_exclusive_mode(idm_sync_daemon, reset_devices):
...
def test_idm__sync_get_lock_shareable_mode(idm_sync_daemon, reset_devices):
